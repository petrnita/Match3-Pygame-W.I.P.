...
class Screen_Layers():
    def __init__(self):
        self.Main: Surface
        self.Board_pic: Surface
        self.Board_con: Surface
        self.Board: Surface
        self.Anim: Surface
...
class Screen_Manager():
    def __init__(self):
        ...
        self.screens.Board_pic = Surface((self.board_size.x, self.board_size.y), pygame.SRCALPHA)
        self.screens.Board_con = self.screens.Board_pic.copy().convert_alpha()
        self.screens.Board_pic.blit(self.board_image, (0, 0))
        self.screens.Anim = self.screens.Board_con.copy().convert_alpha()
        self.screens.Board = self.screens.Board_con.copy().convert_alpha()
        self.gems_offset: vec = vec(0, self.board_offset.y-self.board_size.y-96-12)

    def paint_screen(self):
        self.screens.Main.blit(self.background, (0, 0))
        self.screens.Board_con.fill(COLORS.TRANSPARENT)
        self.screens.Board.fill(COLORS.TRANSPARENT)
        self.screens.Anim.fill(COLORS.TRANSPARENT)
        
    def draw(self):
        self.screens.Main.blit(self.screens.Board_pic, self.board_offset)
        self.screens.Board_con.blit(self.screens.Board, self.gems_offset)
        self.screens.Main.blit(self.screens.Board_con, self.board_offset)
        self.screens.Main.blit(self.screens.Anim, self.board_offset)
